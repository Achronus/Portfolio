...
class Menu():
  ...
  def get_filename(self):
    """
    Used to receive the users file name input. Checks if the file exists, if it does error is displayed. 
    Otherwise, returns the file name with .csv extension added.
    """
    # Get users input
    while True:
      ui = input('=> ').strip('.csv')
